...
define("SITE_SALT", "Jc_~VtymHUyvpvYS2OOgDHlPgrBWx9jliDKO,btCNlcjpE;mD5Pe5S~L:LjtNndAp.Un");
...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://community.microfaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "community.microfaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://community.microfaction.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "community.microfaction.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://community.microfaction.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "community.microfaction.test";
