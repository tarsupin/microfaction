...
/****** Get Replies of a Comment, Recursively ******/
	...
	(
		$commentID			// <int> The ID of the comment to get replies from.
	,	$startNum = 0		// <int> The starting number to get comments from.
	,	$showNum = 10		// <int> The number of comments to return.
	,	$order = "ASC"		// <str> The direction to sort by "ASC" or "DESC"
	)						// RETURNS <int:[str:mixed]> comments for the object, FALSE on failure.
...
/****** Get Comment Data ******/
	...
	,	$columns = "*"		// <str> The columns to retrieve from the comment.
	)						// RETURNS <str:mixed> comments for the object, FALSE on failure.
...
/****** Create a Comment ******/
	...
	(
		$threadID				// <int> The thread ID that you're posting in.
	,	$uniID					// <int> The Uni-Account of the user that is commenting.
	,	$objectID				// <int> The ID of the object being commented on (parent commentID or threadID).
	,	$comment				// <str> The comment to post.
	,	$replyThread = 1		// <int> 1 if replying to thread, 0 if replying to comment.
...
/****** Delete all comments in a thread ******/
	...
	(
		$threadID		// <int> The ID of the thread that contains all comments to delete.
	)					// RETURNS <bool> TRUE if successful, FALSE otherwise.
...
/****** Delete all replies to a comment (recursive) ******/
	...
	(
		$parentID				// <int> The ID of the parent comment.
	,	$commentID				// <int> The ID of the comment to delete the replies of.
	)							// RETURNS <bool> TRUE if successful, FALSE otherwise.
...
/****** Get a list of User Votes (for comments) ******/
	...
	,	$threadID		// <int> The thread ID to search through.
	)					// RETURNS <int:int> a list of your votes, FALSE on failure.
...
/****** Get a User's vote on a comment ******/
	...
	(
		$uniID			// <int> The UniID of the user.
	,	$threadID		// <int> The thread ID the comment is in.
	,	$commentID		// <int> The comment ID to check the vote of.
	)					// RETURNS <int> The vote value.
...
/****** Vote on a Comment ******/
	...
	,	$threadID		// <int> The thread ID the comment is in.
	,	$commentID		// <int> The ID of the comment to vote on.
...
/****** Update Priority Comments ******/
	...
	(
		$threadID	// <int> The thread to run comment prioritization on.
	)				// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Update Reply Priority Comments (recursively, where applicable) ******/
	...
	(
		$parentID	// <int> The comment ID to run comment prioritization on.
	)				// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Display Comments ******/
	...
	(
		$threadData		// <array> The data of the thread.
	,	$comments		// <array> The comments to display.
	)					// RETURNS <void> OUTPUTS HTML of comments
...
/****** Display Comments (Recursive Loop) ******/
	...
	(
		$threadData	// <array> The data of the thread.
	,	$commentID	// <int> The comment ID to recursively loop through.
	,	$step		// <int> The current step that you're looping through.
	,	$extra = 0	// <int> The amount of extra steps to falsify (for ajax purposes).
	)				// RETURNS <bool>
