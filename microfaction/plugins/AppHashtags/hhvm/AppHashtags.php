...
/****** Class Variables ******/
	public static array $userSubs = array();			// <array>
	public static array $userActiveSubs = array();	// <array>
	public static string $userSubsSQL = "";			// <str>
	
	
/****** Get the subscriptions for the user ******/
	public static function getSubscriptions
	(
		int $uniID			// <int> The UniID to get subscriptions for.
	): void					// RETURNS <void>
...
/****** Check if a hashtag exists ******/
	...
	(
		string $hashtag		// <str> The hashtag to verify if it exists or not.
	): bool					// RETURNS <bool>
...
/****** Get a list of hashtags based on priority ******/
	...
	(
		int $priorityLevel = 6	// <int> The minimum priority level to return.
	): array <int, str>						// RETURNS <int:str>
...
/****** Create a MicroFaction Hashtag ******/
	...
	(
		string $hashtag		// <str> The hashtag to create.
	,	int $priority		// <int> The priority integer (9 = default active, 8 = default inactive, 6 = listed, 4 = available)
	): void					// RETURNS <void>
...
/****** Return Category Scan Data for a Thread ******/
	...
	): array <int, mixed>					// RETURNS <int:mixed> a filtered list for SQL.
...
/****** Add a hashtag subscription to a user ******/
	...
	,	string $hashtag			// <str> The hashtag.
	,	bool $subscribe = true	// <bool> TRUE if adding the subscription, FALSE if removing it.
...
/****** Add a hashtag subscription to a user ******/
	...
	(
		int $uniID				// <int> The uniID of the user.
	,	string $hashtag			// <str> The hashtag.
	,	bool $visible = true		// <bool> TRUE to make it visible, FALSE if hiding it.
	): bool						// RETURNS <bool> TRUE if exists, FALSE on failure.
...
/****** Draw your hashtag subscriptions ******/
	...
	(
		string $page = ""		// <str> The page that you're currently on (e.g. "new");
	): void					// RETURNS <void> OUTPUTS HTML for the subscription list, FALSE on failure.
