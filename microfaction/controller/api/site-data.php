...
/*
	****** ABOUT THIS API ******
	This API is used to provide data about this microfaction site, including the name of the site (used for reference)
	and the categories that it has (category key and name).
