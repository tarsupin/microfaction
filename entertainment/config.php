...
if(ENVIRONMENT == "production") {
	...
	// Set Important URLs
	define("SITE_URL", "http://entertainment.microfaction.com");
	define("CDN", "http://cdn.unifaction.com");
	
	// Important Configurations
	$config['site-domain'] = "entertainment.microfaction.com";		#production
...
************************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://entertainment.microfaction.phptesla.com");
	define("CDN", "http://cdn.phptesla.com");
	
	// Important Configurations
	$config['site-domain'] = "entertainment.microfaction.phptesla.com";		#development
...
******************************/
	...
	// Set Important URLs
	define("SITE_URL", "http://entertainment.microfaction.test");
	define("CDN", "http://cdn.test");
	
	// Important Configurations
	$config['site-domain'] = "entertainment.microfaction.test";
